...
public class AutonomousSelection {
	...
	public void setupSelections() {
		String[] choices = new String[] {"Left Gear Peg (backup after)", "Center Gear Peg (backup after)", "Right Gear Peg (backup after)", "Left Gear Peg (don't backup)", "Center Gear Peg (don't backup)", "Right Gear Peg (don't backup)"};
