...
public class AutoLeftBlueAlliance extends CommandGroup {

    public AutoLeftBlueAlliance(boolean withBackup) {

    	// The Robot moves 86 inches forward at 
    	addSequential(new AutoDriveDistance(86.632, RobotMap.AUTO_MOVE_SPEED));
    	
    	// The robot turns 60 degrees to the right 
    	addSequential(new AutoTurn(60.0,RobotMap.TURN_SLOW_SPEED));
    	
    	// The robot drives 36 inches at a slower speed for smooth gear placement
