...
public class CenterGearAuto extends CommandGroup {
	public CenterGearAuto(boolean withBackup) {
		...
		addSequential(new AutoDriveDistance(28.0, RobotMap.AUTO_MOVE_MEDIUM_SPEED));
    	
		/* Move the robot 8 inches forward at a really slow speed to
		 * ensure smooth gear placement.
		 */
		
		addSequential(new AutoDriveDistance(8.0, RobotMap.AUTO_MOVE_SLOW_SPEED)); // Going Really slow and overshooting the distance a bit
